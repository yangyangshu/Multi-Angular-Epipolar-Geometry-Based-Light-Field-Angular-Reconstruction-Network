...
% -------------------------------------------------------------------------
    ...
    opts.conv_f             = 3;
    opts.conv_n             = 49;       % number of intermediate feature maps
    opts.conv_a             = 49;       % angular resolution
    opts.conv_a_l           = 9;        % input angular resolution
    opts.loss               = 'L2';
    opts.loss_add           = 'L2_add';
    ...
    opts.lr_step            = 1000;    % number of epochs to drop learning rate
    ...
    opts.test_HCI_dir           = './data/HCI_Data_depth'; % Path to testing images
    opts.train_dataset          = {};
    ...
    opts.test_dataset           = 'occlusions';  % File name in the list folder
